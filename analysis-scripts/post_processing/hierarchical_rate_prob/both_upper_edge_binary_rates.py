...
pdf_2g1g = lambda parameters: mass_model(
        dict(mass_ratio = q_grid, mass_1 = m1_grid), **{k: parameters[k] for k in m2gap_priors['mass']}) * (m2_grid>parameters['gap_low']+parameters['gap_width']) * (m1_grid>parameters['gap_low']+parameters['gap_width'])
...
np.save('powerlaw1peak2_m2gap_fixed_identical_result_both_upper_edge_binary_rate.npy', rates)
