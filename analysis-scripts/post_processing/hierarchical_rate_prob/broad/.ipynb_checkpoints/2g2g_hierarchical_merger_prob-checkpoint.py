...
def hierarchical_prob(likelihood, samples):
    ...
    for sample in tqdm(samples):
        ...
        hierarchical_weights = new_weights*(likelihood.data['mass_1']*likelihood.data['mass_ratio']>likelihood.parameters['gap_low']+likelihood.parameters['gap_width'])
        non_hierarchical_weights = new_weights*(~((likelihood.data['mass_1']*likelihood.data['mass_ratio']>likelihood.parameters['gap_low']+likelihood.parameters['gap_width'])))
...
def post_process(
    ...
    priors = get_priors(module.priors, conversion=False)
    ...
    np.save('powerlaw1peak2_m2gap_fixed_identical_result_2g2ghierarchical_p.npy', np.array(hierarchical_p))
