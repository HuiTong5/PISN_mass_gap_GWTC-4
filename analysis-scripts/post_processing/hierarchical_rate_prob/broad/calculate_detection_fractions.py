...
def load_injections_o4a(far_cut = 1, snr_cut = 10, save = False, effective=True):
    file = '/home/hui.tong/projects/PISN_GWTC_4/data/injections/samples-rpo4a_v2_20250503133839UTC-1366933504-23846400.hdf'
...
model = '/home/hui.tong/projects/PISN_GWTC_4/models/transition_spin/powerlaw1peak2_m2gap_fixed_identical'
...
injections = load_injections_o4a(effective=True)
vt_data = injections
