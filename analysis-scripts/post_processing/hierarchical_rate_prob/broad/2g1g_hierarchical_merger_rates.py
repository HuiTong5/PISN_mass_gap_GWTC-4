...
m2gap_result = read_in_result('/home/hui.tong/projects/PISN_GWTC_4/models/transition_spin/final_results/powerlaw1peak2_m2gap_fixed_identical_broad-0-1_2025-11-05-23:52:41.122592_result.hdf5')
...
pdf_2g1g = lambda parameters: mass_model(
        dict(mass_ratio = q_grid, mass_1 = m1_grid), **{k: parameters[k] for k in m2gap_priors['mass']}) * (m2_grid<=parameters['gap_low']) * (m1_grid>parameters['gap_low']) * (m1_grid<=parameters['gap_low']+parameters['gap_width'])
...
np.save('powerlaw1peak2_m2gap_fixed_identical_result_2g1g_rate.npy', rates)
