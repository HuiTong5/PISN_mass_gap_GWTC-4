...
priors = dict(
    ...
    chi_eff = dict(
        ...
        w = bilby.prior.Uniform(minimum=0, maximum=1),
        log_sigma_chi_eff_low = bilby.prior.Uniform(minimum=-2, maximum=1),
        mu_chi_eff_low = bilby.prior.Uniform(minimum=-1, maximum=1),
        log_sigma_chi_eff_high = bilby.prior.Uniform(minimum=-2, maximum=1),
        mu_chi_eff_high = bilby.prior.Uniform(minimum=-1, maximum=1),
        xi_chi_eff = bilby.prior.Uniform(minimum=0, maximum=1),
    )
)
