...
def three_component_double_power_law_primary_mass(
    mass, alpha_1, alpha_2, mmin, mmax, break_mass, lam_0, lam_1, mpp_1, sigpp_1, mpp_2, sigpp_2, gaussian_mass_maximum
    ):
    """
...
class m2gap_MultiPeakBrokenPowerLawSmoothedMassDistribution(MultiPeakBrokenPowerLawSmoothedMassDistribution):
...
models = dict(
    mass = m2gap_MultiPeakBrokenPowerLawSmoothedMassDistribution,
)


priors = dict(
    mass = dict(
        alpha_1 = bilby.prior.Uniform(-4, 12),
        alpha_2 = bilby.prior.Uniform(-4, 12),
        ...
        break_mass = bilby.prior.Uniform(20, 50),
